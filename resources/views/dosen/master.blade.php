                        ...
                        <div class="navbar-nav header-right">
                            ...
                            <div class="dlab-side-menu">
                                <div class="search-coundry d-flex align-items-center">
                                    <a class="btn btn-danger" href="{{ url('dosen/logout') }}"><i
                                ...
                                <div class="sidebar-social-link ">
                                    <ul>
                                        ...
                                        <li class="nav-item ">
                                            <a class="btn btn-secondary m-1" href="{{ url('dosen/profil') }}"><i
                                                    class="flaticon-381-user-7"></i></a>
                                        </li>

                                        <li class="nav-item ">
                                            <a class="btn btn-danger m-1 mobile-show"
                                                href="{{ url('dosen/logout') }}" style="display: none;"><i
                                                    class="flaticon-381-turn-off"></i></a>
                                        </li>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="" href="{{ url('dosen/elearning') }}" aria-expanded="false">
                            ...
                            <span class="nav-text">Materi <br>Pembelajaran</span>
                        </a>
                    </li>
                    ...
                    <p class="text-white text-center"><strong>ELMED<br> LMS-DOSEN</strong>
                    </p>
                    <br>
                ...
                <div class="modal fade" id="password_header">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/dosen/auth/password') }}" method="post"
