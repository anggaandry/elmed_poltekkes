                            ...
                            <div class="dlab-side-menu">
                                ...
                                <div class="sidebar-social-link ">
                                    <ul>
                                        ...
                                        <li class="nav-item ">
                                            <a class="btn btn-info m-1 mobile-show" data-bs-toggle="modal" href="#international_class_modal"><i class="bi bi-globe"></i></a>
                                        </li>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="modal fade" id="international_class_modal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <!-- <h5 class="modal-title">{{ tr('ganti password') }}</h5> -->
                                <h5 class="modal-title">Change Class Type</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="mb-3 row">
                                    ...
                                    ?>
                                    <div class="col-6">
                                        <a href="{{ url('/dosen/auth/change_class_type/false') }}" class="btn btn-primary <?php echo $button1 ?>" style="width: 100%;">All Class</a>
                                    </div>
                                    <div class="col-6">
                                        <a href="{{ url('/dosen/auth/change_class_type/true') }}" class="btn btn-success <?php echo $button2 ?>" style="width: 100%;">International Class</a>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="modal-footer">
    ...
    ***********************************-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.dropify').dropify();
            $(".sel2").select2();
            <?php if (!session()->has('ic')) { ?>
                $('#international_class_modal').modal('show');
            <?php } ?>
    ...
    <script>
        function checkHeaderPass() {
            ...
            if (password.length < 8) {
                ...
                $('#display_pass_error').html('<b><?php echo tr('peringatan ') ?>!!!</b> <?php echo tr('password minimal 8 karakter ') ?>');
                return false;
            }

            if (password != confirmPassword) {
                $('#header_display_pass_error').removeClass('d-none');
                $('#display_pass_error').html('<b><?php echo tr('peringatan ') ?>!!!</b> <?php echo tr('password tidak cocok ') ?>');
                return false;
            }
