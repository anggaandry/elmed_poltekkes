                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade {{ $tab == 1 ? 'show active' : '' }}" id="nav-about" role="tabpanel" aria-labelledby="nav-about-tab">
                                    <div class="about-content">
                                        ...
                                        <div class="text-center w-100">
                                            ...
                                            @if ($data->file1)
                                            <a href="{{ asset(LMS_PATH . $data->file1) }}" class="btn btn-primary m-3" download>{{ $data->file1 }} <span class="btn-icon-end"><i class="fa fa-download"></i></span>
                                            </a>
                                            @endif
                                            @if ($data->file2)
                                            <a href="{{ asset(LMS_PATH . $data->file2) }}" class="btn btn-primary m-3" download>{{ $data->file2 }} <span class="btn-icon-end"><i class="fa fa-download"></i></span>
                                            </a>
                                            @endif
                                ...
                                <div class="tab-pane fade {{ $tab == 2 ? 'show active' : '' }}" id="nav-views" role="tabpanel" aria-labelledby="nav-views-tab">
                                    <div class="about-content">
                                        ...
                                        @if (strtotime($class_first->start) < strtotime(date('Y-m-d H:i'))) <div class="row w-100">
                                            <div class="col-9">
                                            ...
                                            <div class="card text-center" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
                                                <div class="p-2 pb-3">
                                                    ...
                                                    @if (strtotime($class_first->start) < strtotime(date('Y-m-d H:i')) && strtotime($class_first->end) > strtotime(date('Y-m-d H:i')))
                                                        ...
                                                        @elseif(strtotime($class_first->end) < strtotime(date('Y-m-d H:i'))) <small class="text-danger"><i class="fa fa-times-square"></i> {{ tr('tidak hadir') }}</small>
                                                            @endif
                                                            @endif
