            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (count($active_elearning) > 0)
                        <h3 class="mb-3">{{ tr('e-learning aktif ') }}<small class="float-end text-primary" style="font-size: 15px;!important">{{ count($active_elearning) }} {{ tr('elearning') }}</small></h3>
                                ...
                                <div class="items p-1">
                                    <a href="{{ url('dosen/elearning/detail?id=' . $item->elearning_id . '&kelas=' . $item->id) }}">
                                        <div class="card" style="box-shadow: rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px;">
                                            ...
                                            <div class="px-3 py-2">
                                                <h4 class="limit-text" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Elearning :{{ $item->elearning->name }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a class="btn btn-primary  mb-3  float-end" href="{{ url('dosen/elearning/form/add') }}"><i class="fa fa-plus-circle"></i> {{ tr('buat elearning') }}</a>
