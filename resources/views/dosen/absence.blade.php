...
@section('script')
        ...
        function load_table() {
            ...
            var table = $('#data-table-1').DataTable({
                ...
                language: {
                    ...
                    processing: '<div class="d-flex justify-content-center"><div class="spinner-border" role="status"><span class="visually-hidden">{{ tr('loading...') }}</span>{{ tr('</div>') }}</div>',
    ...
    <script>
        ...
        function check() {
            ...
            $('#v_id_start').val('');
            $('#start_btn').html('<i class = "fa fa-pencil"></i> {{ tr('mulai absensi') }} ');
            if (typeData == 1) {
                $.ajax({
                    type: 'POST',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        if (data.message == "success") {
                            ...
                            if (res.active == 0) {
                                ...
                                $('#unstart_txt').html('{{ tr('jadwal kelas pindahan belum dimulai') }}');
