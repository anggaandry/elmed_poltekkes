            ...
            <div class="card-body">
                <div id="perintah" class="d-none text-center p-5" style="width:100%; height:300px;">
                    <div class="align-middle">
                        ...
                        <button class="btn btn-primary " id="move_btn" onclick="show_move()"><i class="fa fa-calendar"></i> pindah
                            jadwal</button>
                        <button class="btn btn-success " id="start_btn" onclick="show_absence()"><i class="fa fa-pencil"></i> mulai
                            absensi</button>
                        <button class="btn btn-danger " id="cancel_move_btn" onclick="show_cancel_move()"><i class="fa fa-calendar-times"></i> Batalkan pindah jadwal</button>
                    </div>
                ...
                <div class="d-none" id="tabel">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td width="35%">
                                <h6 id="submit_txt">-</h6>
                                <a href="#delete_modal" data-bs-toggle="modal" class="btn btn-danger btn-xs" id="delete_btn"> hapus absen >></a>
                                <a href="#submit_modal" data-bs-toggle="modal" class="btn btn-success btn-xs d-none" id="submit_btn"> submit absen >>></a>
                                <div class="modal fade" id="submit_modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-danger">Submit absensi</h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="mb-3 col-md-12">
                                                            <p class="text-danger">Apakah anda ingin mensubmit sesi
                                                                belajar ini? absensi
                                                                tidak akan bisa anda edit lagi setelah submit</p>
                                                        </div>
                                                        <div class="mb-3 col-md-12">
                                                            <label class="form-label">Status</label>
                                                            <select name="status" class="form-select">
                                                                <option value="1"><span class="text-success">Hadir</span></option>
                                                                <option value="2"><span class="text-info">Izin</span></option>
                                                                <option value="0"><span class="text-danger">Absen</span></option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-3 col-md-12">
                                ...
                                <div class="modal fade" id="delete_modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-danger">Hapus absensi</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                                </button>
                                            </div>
                                            <form action="{{ url('/dosen/absensi/delete') }}" method="post" id="form_delete">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="mb-3 col-md-12">
                                                            <p class="text-danger">Apakah anda ingin menghapus sesi
                                                                belajar ini?</p>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <table id="data-table-1" class="dislay text-center">
                            <thead class=" bg-primary-light text-white">
                                <tr>
                                    ...
                                    <th class="border-bottom-0 text-white text-center">Mahasiswa</th>
                                    <th class="border-bottom-0 text-white">Alfa</th>
                                    <th class="border-bottom-0 text-white">Hadir</th>
                                    <th class="border-bottom-0 text-white">Izin</th>

                                    <th class="border-bottom-0 text-white">Catatan</th>
                                    <th class="border-bottom-0 text-white">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div class="modal fade" id="move_absence_modal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Pindahkan jadwal</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                </button>
                            </div>
                            <form action="{{ url('/dosen/absensi/move') }}" method="post" id="form_move">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-12">
                                            <label class="form-label">Alasan pemindahan jadwal</label>
                ...
                <div class="modal fade" id="cancel_move_modal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-danger">Batalkan pemindahan jadwal</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                </button>
                            </div>
                            <form action="{{ url('/dosen/absensi/move_cancel') }}" method="post" id="form_cancel_move">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            <p>Apakah anda ingin membatalkan pemindahan jadwal ini?
                                            </p>
                                        </div>
                            ...
                            <form action="{{ url('/dosen/absensi/start') }}" method="post" id="form_start">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-12">
                                            <label class="form-label">Aktivitas pembelajaran hari ini</label>
                ...
                <div class="modal fade" id="activity_edit_modal">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Edit aktivitas pembelajaran dosen</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                </button>
                            </div>
...
<script>
    ...
    function check() {
        ...
        $('#v_id_start').val('');
        $('#start_btn').html('<i class = "fa fa-pencil"></i> mulai absensi');
        if (typeData == 1) {
            $.ajax({
                type: 'POST',
                data: {
                ...
                success: function(data) {
                    ...
                    if (data.message == "success") {
                        ...
                        if (res.active == 0) {
                            ...
                            $('#unstart_txt').html('Jadwal kelas pindahan belum dimulai');
                            $('#move_btn').html(
                                '<i class="fa fa-calendar"></i> Edit pindah jadwal');
                        }
                        ...
                        if (res.active == 2) {
                            ...
                            if (res.check_submit) {
                                ...
                                $('#submit_txt').removeClass('d-none');
                                $('#submit_txt').html(
                                    `<small><i class="text-info"> anda sudah submit di ${res.check_submit.time}</i></small>`
                                );
                            }
                        }
                    ...
                    if (data.message == "success") {
                        ...
                        if (res.schedule) {
                            ...
                            if (res.active == 0) {
                                ...
                                $('#cancel_move_btn').addClass('d-none');
                                $('#submit_txt').addClass('d-none');
                                $('#unstart_txt').html('Jadwal kelas belum dimulai');
                                if (res.check_move) {
                                    $('#unstart_txt').html('Jadwal kelas sudah dipindah ke <br>' + res
                                        .check_move.time_info);
                                    $('#move_btn').html(
                                        '<i class="fa fa-calendar"></i> Edit pindah jadwal');
                                    $('#cancel_move_btn').removeClass('d-none');
                                }
                            ...
                            if (res.active == 2) {
                                ...
                                if (res.check_move) {
                                    ...
                                    $('#start_btn').addClass('d-none');
                                    $('#unstart_txt').html(
                                        'Sesi kelas sudah dipindahkan ke <br>' + res.check_move
                                        .time_info);
                                }
                            }
...
<script>
    ...
    var x = setInterval(function() {
        if (countDownDate != null) {
            ...
            var cont = "<span class='badge badge-danger'>Kelas berakhir dalam ";
            if (days > 0) {
                cont += (days + " Hari ");
            }
