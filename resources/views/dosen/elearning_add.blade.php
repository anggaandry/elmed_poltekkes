...
@section('breadcrumb')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">{{ tr('tambah elearning') }}</a></li>
        </ol>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <form action="{{ url('/dosen/elearning/add') }}" method="post" enctype="multipart/form-data" onsubmit="return check_valid();">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <select class="form-select form-select-lg wide" name="sks_id" required>
                                    ...
                                    @foreach ($subject_data as $item)
                                        <option value="{{ $item->id }}">{{ $item->subject->name }} ({{ tr('prodi') }}
                    ...
                    <div class="card-footer">
                        <div style="width:100%;">
                            <a class="btn  btn-secondary" href="{{ url('dosen/elearning') }}"><span class="btn-icon-start text-secondary"><i class="fa fa-arrow-left-long color-secondary"></i>
                                </span>{{ tr('kembali') }}</a>
