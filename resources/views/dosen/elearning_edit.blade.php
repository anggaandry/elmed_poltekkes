    ...
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a
                    href="{{ url('dosen/elearning/detail?id=' . $data->id . '&kelas=' . $kelas) }}">Detail Elearning</a>
            </li>
            <li class="breadcrumb-item"><a href="javascript:void(0)">Edit elearning</a></li>
        </ol>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12 col-xxl-12">
            <div class="card">
                <form action="{{ url('/dosen/elearning/edit') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="file" class="dropify" name="image"
                                    data-default-file="{{ $data->image ? asset(LMS_PATH . $data->image) : '' }}"
                                    height="200" />
                            </div>
                            <div class="mb-3 col-md-12">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text" class="form-control" id="video_view"
                                    value="{{ $data->video ? 'https://www.youtube.com/watch?v=' : '' }}{{ $data->video }}"
                                    oninput="change_video()">
                            </div>
                            <div class="mb-3 col-md-12">
                                ...
                                <select class="form-select form-select-lg wide" name="sks_id" required>
                                    ...
                                    @foreach ($subject_data as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($data->sks_id == $item->id) selected @endif>{{ $item->subject->name }}
                                            (prodi
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="file" class="dropify"
                                    data-default-file="{{ $data->file1 ? asset(LMS_PATH . $data->file1) : '' }}"
                                    name="file1" height="200" />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label class="form-label">Lampiran 2 (opsional)</label>
                                <input type="file" class="dropify"
                                    data-default-file="{{ $data->file2 ? asset(LMS_PATH . $data->file2) : '' }}"
                                    name="file2" height="200" />
                            </div>
                    ...
                    <div class="card-footer">
                        <div style="width:100%;">
                            <a class="btn  btn-secondary"
                                href="{{ url('dosen/elearning/detail?id=' . $item->id . '&kelas=' . $kelas) }}"><span
