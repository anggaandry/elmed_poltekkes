            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (count($active_quiz) > 0)
                        <h3 class="mb-3">Kuis Aktif <small class="float-end text-primary"
                                style="font-size: 15px;!important">{{ count($active_quiz) }} Kuis</small></h3>
                    ...
                    <div class="row">
                        <div class="col-xxl-4 col-xl-6">
                            ...
                            <small id="info_finding_">Ditemukan 0 Kuis</small>
                    ...
                    <div class="p-5 justify-content-center align-items-center text-center w-100 align-middle d-none"
                        ...
                        <div class="mt-5">
                            ...
                            <h6 class="mt-3">Kuis tidak ditemukan</h6>
                            <!-- <a class="btn btn-primary btn-xs mb-3 mt-3" href="{{ url('dosen/kuis/form/add') }}"> <i
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                class="fa fa-plus-circle"></i> Buat Kuis</a> -->
                            <br>
                            <br>
                        </div>
