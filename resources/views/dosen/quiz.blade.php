            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (count($active_quiz) > 0)
                        <h3 class="mb-3">{{ tr('kuis aktif') }}<small class="float-end text-primary" style="font-size: 15px;!important">{{ count($active_quiz) }} {{ tr('kuis') }}</small></h3>
                        <div class="owl-carousel owl-carousel owl-loaded front-view-slider mb-4">
                            @foreach ($active_quiz as $item)
                                <div class="items">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a class="btn btn-primary  mb-3  float-end" href="#add" data-bs-toggle="modal"><i class="fa fa-plus-circle"></i> Buat
                                Kuis</a>
                            <div class="modal fade" id="add">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">{{ tr('tambah kuis baru') }}</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal">
                                            </button>
                                        </div>
                                        <form action="{{ url('/dosen/kuis/add') }}" method="post">
                                            {{ csrf_field() }}
                    ...
                    <div class="p-5 justify-content-center align-items-center text-center w-100 align-middle d-none" id="nodata_" style="height: 500px;">
                        ...
                        <div class="mt-5">
                            ...
                            <!-- <a class="btn btn-primary btn-xs mb-3 mt-3" href="{{ url('dosen/kuis/form/add') }}"><i class="fa fa-plus-circle"></i> {{ tr('buat kuis') }}</a> -->
...
@section('script')
    <script>
        ...
        let timer;
        var page_ = 1;
        var addition = {{ count($active_quiz) }};
