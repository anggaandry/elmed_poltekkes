...
@section('script')
    <script>
        function answer(el, id) {
            ...
            var exam_ = "{{ $qc->exam->id }}";
            var exam_class_ = "{{ $qc->id }}";
            var question_ = id;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    exam_id: exam_,
                    exam_question_id: question_,
                    exam_class_id: exam_class_,
                    answer: answer_,
                },
                url: "{{ url('mahasiswa/ujian/ajax/answer') }}",
        ...
        function file(el, id) {
            ...
            formData.append('exam_id', "{{ $qc->exam->id }}");
            formData.append('exam_class_id', "{{ $qc->id }}");
            formData.append('exam_question_id', id);
            ...
            $.ajax({
                ...
                url: "{{ url('mahasiswa/ujian/ajax/file') }}",
                success: function(data) {
                    console.log(data);
                    if (data.code == 1) {
                        $("#btn-" + id).attr('disabled', false);
        ...
        function delete_(id, type) {
            ...
            $.ajax({
                ...
                url: "{{ url('mahasiswa/ujian/ajax/reset') }}",
                success: function(data) {
                    console.log(data);
                    if (data.code == 1) {
                        show_toast(1, data.message);
