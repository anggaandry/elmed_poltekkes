...
@section('breadcrumb')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">Tambah Role</a></li>
        </ol>
    </div>
@endsection
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" name="name"
                                    placeholder="Ex. Admin/Inventory/Keuangan/Admin Fakutas A" required>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label class="form-label">Akses Prodi</label>
                                <select class="form-select form-select-lg wide" name="prodi_id"
