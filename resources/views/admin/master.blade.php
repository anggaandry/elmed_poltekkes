...
<head>
    ...
    <meta name="description" content="ELMED {{ $auth->university->name }}" />
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ url('4dm1n') }}" class="brand-logo">


                <img src="{{ asset(LOGO_PATH . ($auth->university->logo ? $auth->university->logo : 'default.png')) }}" class="logo-abbr" style="margin: 5%" height="65" alt="" />
                        ...
                        <div class="navbar-nav header-right">
                            ...
                            <div class="dlab-side-menu">
                                <div class="search-coundry d-flex align-items-center">
                                    <a class="btn btn-danger mobile-hide" href="{{ url('4dm1n/logout') }}"><i class="flaticon-381-turn-off"></i></a>
                                </div>
                                <div class="sidebar-social-link ">
                                    <ul>
                                        ...
                                        <li class="nav-item ">
                                            <button class="btn btn-dark m-1 " data-bs-toggle="modal" data-bs-target="#password_header"><i class="flaticon-381-lock-1"></i></button>
                                        </li>

                                        <li class="nav-item ">
                                            <button class="btn btn-secondary m-1" data-bs-toggle="modal" data-bs-target="#profile_header"><i class="flaticon-381-user-7"></i></button>
                                        </li>

                                        <li class="nav-item ">
                                            @if ($auth->lang == 'id')
                                                <a class="btn btn-info m-1 px-3 py-2" href="{{ url('/4dm1n/auth/lang?id=' . $auth->id . '&lang=en') }}"><img src="{{ asset('images/icon/english.png') }}" height="25" alt="language"></a>
                                            @else
                                                <a class="btn btn-info m-1 px-3 py-2" href="{{ url('/4dm1n/auth/lang?id=' . $auth->id . '&lang=id') }}"><img src="{{ asset('images/icon/bahasa.png') }}" height="25" alt="language"></a>
                                            @endif
                                        </li>

                                        <li class="nav-item ">
                                            <a class="btn btn-danger m-1 mobile-show" href="{{ url('4dm1n/logout') }}" style="display: none;"><i class="flaticon-381-turn-off"></i></a>
                                        </li>
                                ...
                                <ul>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link" data-bs-toggle="modal" href="#avatar_header" role="button" data-bs-toggle="dropdown">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="" href="{{ url('4dm1n/dashboard') }}" aria-expanded="false">
                    ...
                    @if (can_parent('Master data'))
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                                <i class="bi bi-hdd"></i>

                                <span class="nav-text">{{ tr('master data') }}</span>
                            </a>
                            <ul aria-expanded="false">
                                @if (can('Ruangan', 'view'))
                                    <li><a href="{{ url('4dm1n/ruangan') }}">{{ tr('ruangan') }}</a></li>
                                @endif
                                @if (can('Jurusan', 'view'))
                                    <li><a href="{{ url('4dm1n/jurusan') }}">{{ tr('jurusan') }}</a></li>
                                @endif
                                @if (can('Jenis prodi', 'view'))
                                    <li><a href="{{ url('4dm1n/jenis_prodi') }}">{{ tr('jenis prodi') }}</a></li>
                                @endif
                                @if (can('Prodi', 'view'))
                                    <li><a href="{{ url('4dm1n/prodi') }}">{{ tr('prodi') }}</a></li>
                                @endif
                                @if (can('Prodi Lengkap', 'view'))
                                    <li><a href="{{ url('4dm1n/full_prodi') }}">{{ tr('prodi lengkap') }}</a></li>
                                @endif
                                @if (can('Mata Kuliah', 'view'))
                                    <li><a href="{{ url('4dm1n/matkul') }}">{{ tr('mata kuliah') }}</a></li>
                                @endif
                            </ul>
                    ...
                    @if (can_parent('Akademik'))
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                                <i class="bi bi-layers"></i>

                                <span class="nav-text">{{ tr('akademik') }}</span>
                            </a>
                            <ul aria-expanded="false">
                                @if (can('Semester', 'view'))
                                    <li><a href="{{ url('4dm1n/semester') }}">{{ tr('semester') }}</a></li>
                                @endif
                                @if (can('Kalender', 'view'))
                                    <li><a href="{{ url('4dm1n/kalender') }}">{{ tr('kalender') }}</a></li>
                                @endif
                                @if (can('SKS', 'view'))
                                    <li><a href="{{ url('4dm1n/sks') }}">{{ tr('matkul prodi') }}</a></li>
                                @endif
                                @if (can('Kelas', 'view'))
                                    <li><a href="{{ url('4dm1n/kelas') }}">{{ tr('kelas') }}</a></li>
                                @endif
                                @if (can('Jadwal', 'view'))
                                    <li><a href="{{ url('4dm1n/jadwal') }}">{{ tr('jadwal') }}</a></li>
                                @endif
                                @if (can('Absensi', 'view'))
                                    <li><a href="{{ url('4dm1n/absensi') }}">{{ tr('absensi') }}</a></li>
                                @endif
                    ...
                    @if (can('Dosen', 'view'))
                        <li>
                            <a class="" href="{{ url('4dm1n/dosen') }}" aria-expanded="false">
                                <i class="bi bi-easel"></i>
                                <span class="nav-text">{{ tr('dosen') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (can('Dosen', 'view'))
                        <li>
                            <a class="" href="{{ url('4dm1n/mahasiswa') }}" aria-expanded="false">
                                <i class="bi bi-pen"></i>
                                <span class="nav-text">{{ tr('mahasiswa') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (can_parent('LMS'))
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                                ...
                                <span class="nav-text">{{ tr('lms') }}</span>
                            </a>
                            <ul aria-expanded="false">
                                @if (can('Soal', 'view'))
                                    <li><a href="{{ url('4dm1n/soal') }}">{{ tr('bank soal') }}</a></li>
                                @endif
                                @if (can('Materi', 'view'))
                                    <li><a href="{{ url('4dm1n/elearning') }}">{{ tr('elearning') }}</a></li>
                                @endif

                                @if (can('Kuis', 'view'))
                                    <li><a href="{{ url('4dm1n/kuis') }}">{{ tr('kuis') }}</a></li>
                                @endif

                                @if (can('Ujian', 'view'))
                                    <li><a href="{{ url('4dm1n/ujian') }}">{{ tr('ujian') }}</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (can_parent('Akun'))
                        <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                                ...
                                <span class="nav-text">{{ tr('akun') }}</span>
                            </a>
                            <ul aria-expanded="false">
                                @if (can('Role', 'view'))
                                    <li><a href="{{ url('4dm1n/role') }}">{{ tr('role') }}</a></li>
                                @endif
                                @if (can('Admin', 'view'))
                                    <li><a href="{{ url('4dm1n/akun/admin') }}">{{ tr('admin') }}</a></li>
                                @endif
                                @if (can('Akun dosen', 'view'))
                                    <li><a href="{{ url('4dm1n/akun/dosen') }}">{{ tr('dosen') }}</a></li>
                                @endif
                                @if (can('Akun mahasiswa', 'view'))
                                    <li><a href="{{ url('4dm1n/akun/mahasiswa') }}">{{ tr('mahasiswa') }}</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif

                    @if (can('Log data', 'view'))
                        <li>
                            <a class="" href="{{ url('4dm1n/log') }}" aria-expanded="false">
                                <i class="bi bi-card-text"></i>
                                <span class="nav-text">{{ tr('log data') }}</span>
                            </a>
                        </li>
                    @endif

                    @if (can('Konfigurasi', 'view'))
                        <li>
                            <a class="" href="{{ url('4dm1n/konfigurasi') }}" aria-expanded="false">
                                <i class="bi bi-gear"></i>
                                <span class="nav-text">{{ tr('konfigurasi') }}</span>
                            </a>
                        </li>
                    @endif
                ...
                <div class="copyright mt-3">
                    <p><strong>{{ tr('elmed admin') }}</strong> © 2022 All Rights Reserved</p>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="modal fade" id="password_header">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/4dm1n/auth/password') }}" method="post" onsubmit="return checkHeaderPass()" enctype="multipart/form-data">
                                {{ csrf_field() }}
                ...
                <div class="modal fade" id="avatar_header">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">{{ tr('ganti avatar') }}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                </button>
                            </div>
                            <form action="{{ url('/4dm1n/auth/avatar') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $auth->id }}">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="mb-3 col-md-12">
                                            ...
                                            <input type="file" class="dropify" data-default-file="{{ $auth->avatar ? asset(AVATAR_PATH . $auth->avatar) : '' }}" name="avatar" height="200" />
                                        </div>
                ...
                <div class="modal fade" id="profile_header">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">{{ tr('profil akun') }}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal">
                                </button>
                            </div>
                            <form action="{{ url('/4dm1n/auth/profile') }}" method="post">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $auth->id }}">
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">{{ tr('nip') }}</label>
                                            <input type="text" class="form-control" name="nip" value="{{ $auth->nip }}" disabled>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                            <label class="form-label">{{ tr('role') }}</label>
                                            <input type="text" class="form-control" value="{{ $auth->role->name }}" disabled>
                                        </div>
                                        <div class="mb-3 col-md-6">
                                        ...
                                        <div class="mb-3 col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="birthdate" value="{{ $auth->birthdate }}" required>
                                        </div>
