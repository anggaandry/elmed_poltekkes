        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            @if (can('Ruangan', 'view'))
                            <li><a href="{{ url('4dm1n/ruangan') }}">Ruangan</a></li>
                            @endif
                            @if (can('Jurusan', 'view'))
                            <li><a href="{{ url('4dm1n/jurusan') }}">Jurusan</a></li>
                            @endif
                            @if (can('Jenis prodi', 'view'))
                            <li><a href="{{ url('4dm1n/jenis_prodi') }}">Jenis prodi</a></li>
                            @endif
                            @if (can('Prodi', 'view'))
                            <li><a href="{{ url('4dm1n/prodi') }}">Prodi</a></li>
                            @endif
                            @if (can('Prodi Lengkap', 'view'))
                            <li><a href="{{ url('4dm1n/prodi_lengkap') }}">Prodi Lengkap</a></li>
                            @endif
                            @if (can('Mata Kuliah', 'view'))
                            <li><a href="{{ url('4dm1n/matkul') }}">Mata kuliah</a></li>
                            @endif
                        </ul>
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ url('4dm1n/semester') }}">Semester</a></li>
                            @endif
                            @if (can('Kalender', 'view'))
                            <li><a href="{{ url('4dm1n/kalender') }}">Kalender</a></li>
                            @endif
                            @if (can('SKS', 'view'))
                            <li><a href="{{ url('4dm1n/sks') }}">Matkul Prodi</a></li>
                            @endif
                            @if (can('Kelas', 'view'))
                            <li><a href="{{ url('4dm1n/kelas') }}">Kelas</a></li>
                            @endif
                            @if (can('Jadwal', 'view'))
                            <li><a href="{{ url('4dm1n/jadwal') }}">Jadwal</a></li>
                            @endif
                            @if (can('Absensi', 'view'))
                            <li><a href="{{ url('4dm1n/absensi') }}">Absensi</a></li>
                            @endif
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            @if (can('Soal', 'view'))
                            <li><a href="{{ url('4dm1n/soal') }}">Bank soal</a></li>
                            @endif
                            @if (can('Materi', 'view'))
                            <li><a href="{{ url('4dm1n/elearning') }}">Elearning</a></li>
                            @endif

                            @if (can('Kuis', 'view'))
                            <li><a href="{{ url('4dm1n/kuis') }}">Kuis</a></li>
                            @endif

                            @if (can('Ujian', 'view'))
                            <li><a href="{{ url('4dm1n/ujian') }}">Ujian</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
                    ...
                    <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            @if (can('Role', 'view'))
                            <li><a href="{{ url('4dm1n/role') }}">Role</a></li>
                            @endif
                            @if (can('Admin', 'view'))
                            <li><a href="{{ url('4dm1n/akun/admin') }}">Admin</a></li>
                            @endif
                            @if (can('Akun dosen', 'view'))
                            <li><a href="{{ url('4dm1n/akun/dosen') }}">Dosen</a></li>
                            @endif
                            @if (can('Akun mahasiswa', 'view'))
                            <li><a href="{{ url('4dm1n/akun/mahasiswa') }}">Mahasiswa</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
                    ...
                    <li>
                        <a class="" href="{{ url('4dm1n/log') }}" aria-expanded="false">
                            ...
                            <span class="nav-text">Log data</span>
                        </a>
                    </li>
                    @endif
                ...
                <div class="copyright mt-3">
                    <p><strong>ELMED Admin</strong> © 2022 All Rights Reserved</p>
