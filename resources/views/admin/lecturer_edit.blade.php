...
@section('breadcrumb')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">{{ tr('edit dosen') }}</a></li>
        </ol>
    </div>
@endsection
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-select form-select-lg wide" name="identity">
                                    <option value="NIDN" @if ($lecturer_data->identity == 'NIDN') selected @endif>{{ tr('nidn') }}</option>
                                    <option value="NUP" @if ($lecturer_data->identity == 'NUP') selected @endif>{{ tr('nup') }}</option>
                                    <option value="NIDK" @if ($lecturer_data->identity == 'NIDK') selected @endif>{{ tr('nidk') }}</option>
                                </select>
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-select form-select-lg wide" name="status">
                                    <option value="1" @if ($lecturer_data->status == '1') selected @endif>{{ tr('aktif') }}</option>
