...
@section('breadcrumb')
    <div class="row page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="javascript:void(0)">Jenis prodi</a></li>
        </ol>
    </div>
@endsection
                    ...
                    <div class="card-header">
                        <div style="width:100%;">
                            <a class="btn  btn-primary float-end" data-bs-toggle="modal" href="#add"><span
                                ...
                                </span>Tambah jenis prodi</a>
                            <div class="modal fade" id="add">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Tambah jenis prodi</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-12">
                                                        <label class="form-label">Nama jenis prodi</label>
                                                ...
                                                @if (can($key_, 'edit'))
                                                    ...
                                                    <div class="modal fade" id="edit{{ $item->id }}">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title">Edit jenis prodi</h5>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal">
                                                                    </button>
                                                                </div>
                                                                <form action="{{ url('/4dm1n/jenis_prodi/edit') }}"
                                                                    method="post">
                                                                    {{ csrf_field() }}
                                                                    ...
                                                                    <div class="modal-body text-start">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="mb-3 col-md-12">
                                                                                <label class="form-label">Nama jenis
                                                                                    prodi</label>
                                                    ...
                                                    <div class="modal fade" id="delete{{ $item->id }}">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Apakah anda ingin menghapus jenis prodi
                                                                        <b>{{ $item->name }}</b>
                                                                    </p>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-danger light"
                                                                        data-bs-dismiss="modal">Tutup</button>
                                                                    <a href="{{ url('4dm1n/jenis_prodi/delete/' . $item->id) }}"
